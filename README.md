# Independent Pen Makers

## Live links
- Leaflet Map http://mwynne.ca/independent-pen-makers/
- Google Sheet https://docs.google.com/spreadsheets/d/1z0usZfM-wudUkszbZGbaUEKU7WEOXgKaHlVCdVzC_NI/edit?gid=0#gid=0
- Deployment https://github.com/mywynne/independent-pen-makers

## Credits (and licenses)
Built following the step-by-step tutorial in *Hands-On Data Visualization* https://handsondataviz.org/leaflet-maps-with-google-sheets.html
